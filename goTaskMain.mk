...
JAVA_FLAGS = -classpath "$(Bioc)/class:lib/commons-compress-1.4.1.jar:lib/commons-io-2.4.jar:lib/json-simple-1.1.jar:lib/lingpipe-4.1.0.jar:external/BioC_Java_1.0/lib/bioc.jar:external/BioC_Java_1.0/lib/biolemmatizer-core-1.1-jar-with-dependencies.jar:external/BioC_Java_1.0/lib/junit-4.1.1.jar:external/BioC_Java_1.0/lib/stax-utils.jar:external/BioC_Java_1.0/lib/stax2-api-3.1.1.jar:external/BioC_Java_1.0/lib/woodstox-core-asl-4.15.jar:external/BioC_Java_1.0/lib/xmlunit-1.4.jar"
JAVAC_FLAGS = \
$(JAVA_FLAGS) \
