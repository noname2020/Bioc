...
JAVA_FLAGS = -classpath "$(Bioc)/class:lib/commons-compress-1.4.1.jar:lib/commons-io-2.4.jar:lib/json-simple-1.1.jar:lib/lingpipe-4.1.0.jar"
JAVAC_FLAGS = \
$(JAVA_FLAGS) \
...
all: class link-resources
	...
	$(JAVA) -Xmx2g -Xms2g $(JAVA_FLAGS) GoTaskMain
